...
do
	...
	if home then
		local stateFile = io.open(home .. "/.config/hypr/hyprlab-settings/ui.conf", "r")
...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("~/.config/hypr/hyprlab-scripts/hyprlab-exit.sh"), {
